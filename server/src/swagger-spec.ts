...
export const swaggerSpec = {
  ...
  "paths": {
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "operator": {
                    "type": "string",
                    "example": "London Northwestern Railway"
                  },
                  "platform": {
                    "type": "string",
                    "example": "1"
    ...
    "/api/arrivals": {
      ...
      "post": {
        "summary": "Add a new arrival for a specific railway station",
        "description": "Creates a new arrival entry linked to the specified station code.",
        "requestBody": {
          "required": true,
          "content": {
            "application/json": {
